<html>
    ...
    <body>
        <div class="container">
            <h1>
                <img src="https://cdn-icons-png.flaticon.com/128/14090/14090276.png" style="width: 20px;height:auto;" alt="logo-header" class="logo">
                Notification: Queue Voided.
            </h1>
            <p>Dear Customer, <b><?= htmlspecialchars($name) ?></b></p>
            <p>We sincerely apologize, your queue time has lapsed beyond our active service and your queue has been voided.</p><br>
            <p> Details of expired transaction:</p>
            <table class="details">
                <tr>
                    <th>Queue Number:</th>
